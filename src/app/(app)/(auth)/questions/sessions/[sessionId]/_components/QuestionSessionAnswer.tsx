      ...
      case QuestionType.TRUE_FALSE:
        return (
          <QuestionTrueFalse
            ...
            initialUserAnswer={
              (questionMap.userAnswer as unknown as boolean) || false
            }
          />
        );
      ...
      case QuestionType.MATCHING:
        return (
          <QuestionMatching
            ...
            initialUserAnswer={
              (questionMap.userAnswer as SubmissionAnswersForMatchingAppDto[]) ||
              []
            }
          />
        );
      case QuestionType.MULTIPLE_CHOICE:
        return (
          <QuestionMultipleChoice
            ...
            initialUserAnswer={(questionMap.userAnswer as number[]) || []}
          />
        );
